...
function ui.highlights()
  return {
    ...
    NavicIconsArray = { link = "@lsp.type.variable" },
    NavicIconsObject = { link = "@lsp.type.class" },
    NavicIconsKey = { link = "@lsp.type.variable" },
    NavicIconsKeyword = { link = "@keyword" },
    NavicIconsNull = { link = "@lsp.type.variable" },
    ...
    AerialVariable = { link = "@lsp.type.variable" },
